...
class BeamSearchHelper(object):
    ...
    def __init__(self, cell, beam_size, stop_token, initial_state, initial_input,
        ...
        print 'Batch size is now', self.batch_size
    ...
    def beam_setup(self, time):
        ...
        print 'Cand symbols', cand_symbols.get_shape()
        print 'Cand logprobs', cand_logprobs.get_shape()
    ...
    def beam_loop(self, time, cell_output, cell_state, loop_state):
        ...
        # print past_cand_symbols.get_shape(), past_cand_logprobs.get_shape(), past_beam_symbols.get_shape(), past_beam_logprobs.get_shape()
